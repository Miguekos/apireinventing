...
module.exports = async app => {
  ...
  app.post(
    "/api/v2.0/almace/listar_produc_ordtra_ingres",
    async (req, res, next) => {
      try {
        let query1;
  ...
  app.post(
    "/api/v2.0/almace/listar_produc_operac_salida",
    async (req, res, next) => {
      try {
        let query1;
  ...
  app.post("/api/v2.0/almace/insert_produc_ingsal", async (req, res, next) => {
    try {
      let query1;
  ...
  app.post(
    "/api/v2.0/almace/quitar_produc_agrega_ingsal",
    async (req, res, next) => {
      try {
        let query1;
  ...
  app.post(
    "/api/v2.0/almace/listar_docume_agrega_ingsal",
    async (req, res, next) => {
      try {
        let query1;
  ...
  app.post(
    "/api/v2.0/almace/listar_produc_agrega_ingsal",
    async (req, res, next) => {
      try {
        let query1;
  ...
  app.post("/api/v2.0/almace/grabar_transa_ingsal", async (req, res, next) => {
    try {
      let query1;
