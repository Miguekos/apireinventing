...
module.exports = async (app) => {
    ...
    app.get("/api/v2.0/personas/natural/:docide", async (req, res, next) => {
        try {
            let query;
    ...
    // para traer todos los usuarios
    app.get("/api/v2.0/personas/juridica/:docide", async (req, res, next) => {
        try {
            let query;
            const doc_ide = req.params.docide;
            if (doc_ide == "all") {
    ...
    app.post("/api/v2.0/personas/natural", async (req, res, next) => {
        try {
    ...
    app.post("/api/v2.0/personas/juridica", async (req, res, next) => {
        try {
            var doc_ide = req.body.doc_ide;
