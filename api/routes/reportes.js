...
module.exports = async (app) => {
    ...
    app.get("/api/v2.0/reportes/combo_almacen", async (req, res, next) => {
        try {            
    ...
    app.post("/api/v2.0/reportes/rep_kardex", async (req, res, next) => {
        try {            
   ...
   app.post("/api/v2.0/reportes/rep_invent_valori", async (req, res, next) => {
    try {            
        var cod_emp = req.body.cod_emp;
        var cod_alm = req.body.cod_alm;
        var nom_art = req.body.nom_art;
   ...
   //filtro (agrupamiento)
   app.get("/api/v2.0/reportes/tipo_agrupa", async (req, res, next) => {
    try {            
   ...
   app.get("/api/v2.0/reportes/fecha_actualizacion", async (req, res, next) => {
    try {            
    ...
    // mostrar
   app.post("/api/v2.0/reportes/reporte_diario", async (req, res, next) => {
    try {            
    ...
    app.post("/api/v2.0/reportes/produccion_operaciones", async (req, res, next) => {
        try {            
    ...
    app.get("/api/v2.0/reportes/tipo_trabajo", async (req, res, next) => {
        try {            
            var query;
            query = `   
    ...
    app.post("/api/v2.0/reportes/seguimiento_mantenimiento", async (req, res, next) => {
        try {            
            var cod_ope = req.body.cod_ope;
            var pla_veh = req.body.pla_veh;            
