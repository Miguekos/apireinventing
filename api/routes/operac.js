...
module.exports = async (app) => {
    ...
    app.post("/api/v1.0/operac/tcservic", async (req, res, next) => {
        try {
            let query;
    ...
    // ELIMINAR 
    app.delete("/api/v1.0/operac/tcservic", async (req, res, next) => {
        try {
            let query;
            var cod_ser = req.body.cod_ser;
    ...
    /////////////////////////////////////TCTIPSER///////////////////////////////////
    // mostrar 
    app.get("/api/v1.0/operac/tctipser/:nom_ser", async (req, res, next) => {
        try {
            let query;
            var nom_ser = req.params.nom_ser;
            if (nom_ser == null || nom_ser.trim() =='' || nom_ser == '-1') {
    ...
    app.post("/api/v1.0/operac/tctipser", async (req, res, next) => {
        try {
            let query;
            var nom_ser = req.body.nom_ser;
    ...
    // ELIMINAR 
    app.delete("/api/v1.0/operac/tctipser", async (req, res, next) => {
        try {
            let query;
            var tip_ser = req.body.tip_ser;
    ...
    ///////////////////////////////////////////// TCTIPTRA ///////////////////////////////////
    // mostrar 
    app.get("/api/v1.0/operac/tctiptra/:nom_tra", async (req, res, next) => {
        try {
            let query;
    ...
    app.post("/api/v1.0/operac/tctiptra", async (req, res, next) => {
        try {
            let query;
