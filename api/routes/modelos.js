...
module.exports = async (app) => {
    // TRAER MODELOS
    app.get("/api/v2.0/modelos/:modveh", async (req, res, next) => {
        try {
            let query;
    ...
    app.get("/api/v2.0/modelos/marcas/:modmar", async (req, res, next) => {
        try {
            let query;
    ...
    // AGREGAR MODELOS
    app.post("/api/v2.0/modelos", async (req, res, next) => {
        try {
    ...
    // ACTUALIZAR MODELO
    app.put("/api/v2.0/modelos", async (req, res, next) => {
        try {
            const co_modveh = req.body.co_modveh;
